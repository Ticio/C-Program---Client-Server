 ...
 * Parameters: socket
 * Purpose: generate 5 random numbers and send it to the client - Option 2
 */
void getRandomNumbers(int socket){
    ...
    for(i=0; i < 5; ++i){
        sprintf(number, "%d", ((rand()%1000)+1)); // converting int to string 
 ...
 * Author: Ticio Victoriano
 * Parameters: socket
 * Purpose: declare a utsname variable and send the data it holds to the client - Option 3
 */
 ...
 * Author: Ticio Victoriano
 * Parameters: socket
 * Purpose: read the file names in the upload folder and the data to the client - Option 4
 */
